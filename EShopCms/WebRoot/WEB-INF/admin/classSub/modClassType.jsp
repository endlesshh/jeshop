...
<body>
        ...
        <form  action="modSubClassType.jspx" method="post">
        <input type="hidden" name="id" value="<s:property value="jettype.getId()"/>" />
  ...
  <thead>
         <tr>
          ...
          <tr>
            <td>分类名称</td>
            <td><input type="text" size="40" name="className" value="<s:property value="jettype.getClassName()"/>" /></td>
          </tr>
          <tr>
            <td>选择频道</td>
          ...
          <tr>
            <td>开始时间</td>
            <td><input type="text" size="20" value="<s:property value="jettype.getStarttime()"/>" name="starttime" readOnly onClick="setDay(this);"/></td>
          </tr>
          <tr>
            <td>结束时间</td>
            <td><input type="text" size="20" name="endtime" value="<s:property value="jettype.getEndtime()"/>" readOnly onClick="setDay(this);"/></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
