...
<body>
<form action="createFile.jspx" method="post">
<table width="100%"  border="00" cellpadding="0" cellspacing="1">
 <tr>
    <td colspan="3" align="center">模板文件说明：本处模板路径为WEB-INF/front/下面的模板文件，修改前请确认文件或者下载备份文件</td>
    </tr>
...
<table  border="00" cellspacing="1" cellpadding="0" id="table" class="sortable">
 <thead> <tr>
  ...
  <tr>
    ...
    <td><a href="dwonFile.jspx?fileName=<s:property value="getName()"/> "> 下载</a></td>
    <td><a href="delteFile.jspx?fileName=<s:property value="getName()"/> " onClick="return confirm('是否确认删除模板<s:property value="getName()"/> ')">删除</a></td>
    <td><a href="modMuban.jspx?fileName=<s:property value="getName()"/> ">修改</a></td>
  </tr>
  </s:iterator>
  </tbody>
  <tr>
