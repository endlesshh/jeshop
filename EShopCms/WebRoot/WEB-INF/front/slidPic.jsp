 ...
 <s:set name="pname" value="getPicUrl()"/>
  <s:if test="#pname!=null">
	    <div id="fragment-<s:property value="#clist.index+1"/>" class="ui-tabs-panel" style="">
			<img width="360" height="250" src="../upfile/<s:property value="getPicUrl()"/>" alt="" />
			 <div class="info" >
				<h2><a href="<s:property value="getLinkUrl()"/>" ><s:property value="getName()"/></a></h2>
				<p><a href="#" ><s:property value="getText()"/></a></p>
			 </div>
	    </div>
        </s:if>
        </s:iterator>
