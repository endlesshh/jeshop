 <!--自定义商品列表-->
  ...
  <tr>
    <td align="center">
    <div style="padding:3px; background-image:url(images/watercolor-bg.gif); background-repeat:no-repeat;">
    <a href="ShowProduct_<s:property value="getProductId()"/>.html?showProduct.jsp">
  
    <img border="0" width="130" height="140" style="padding:3px;" title="header=[] body=[<img width=250 height=250 src='../upfile/<s:property value="getProductThumb()"/>'">
