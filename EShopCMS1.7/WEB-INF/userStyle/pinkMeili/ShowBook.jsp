...
<div style="height:25px; background-color:#FFCCCC; padding-top:8px; padding:5px;">留言主题：<b><s:property value="getBookTitle()"/></b></div>
<div style="height:25px; background-color:#FFCCCC; padding-top:8px; padding:5px;">留言内容：<s:property value="getContent()"/><br></div>
<div style="height:25px; background-color:#FFCCCC; padding-top:8px; padding:5px;">店家回复内容：<s:property value="getRecontent()"/>
</div>
