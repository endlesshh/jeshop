...
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" align="center" valign="middle"><div style="height:25px; background-color:#FFCCFF;">商品评论</div>    </td>
  </tr>
  <tr>
    <td colspan="2">
...
<form action="updateUserBook.jspx" method="post" onsubmit="return orderCheck()">
