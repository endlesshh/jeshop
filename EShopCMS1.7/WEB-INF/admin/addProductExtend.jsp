...
<table width="95%"  border="00" cellpadding="0" cellspacing="1" class="sortable" id="table">
    <thead>
    <tr>
    <th colspan="3">商品信息自定义拓展信息</th>
   </tr></thead>
    <tr>
      <td colspan="3">已经存在的字段显示（本地方信息是您的商品浏览过程中能显示的） </td>
    </tr>
    ...
    <td width="40%">值：<a href="showDetailEx.jspx?channelId=<s:property value="getChannelId()"/>&productId=<s:property value="getProductId()"/>&varname=<s:property value="toString()"/>">    修改字段值</a></td>
    <td width="41%"><a href="deletExtend.jspx?channelId=<s:property value="getChannelId()"/>&varname=<s:property value="toString()"/>&productId=<s:property value="getProductId()"/>">删除字段</a></td>
  </tr>
      </s:iterator>
  </table>

<form action="setextendProduct.jspx" method="post">
<input type="hidden" name="channelId" value="<s:property value="getChannelId()"/>" />
<input type="hidden" name="productId" value="<s:property value="getProductId()"/>" />
 <table width="95%"  border="00" cellpadding="0" cellspacing="1" class="sortable" id="table">
    <thead>
    <tr>
    <th colspan="4">商品信息自定义拓展信息</th>
   </tr></thead>
    <tr>
      <td colspan="4">字段名称必须采用英文名称 </td>
    </tr>
  
   <tr>
     <td >&nbsp;自定义字段：      </td>
     
    <td colspan="2" ><input type="text" size="10" name="keyName" /></td>
    </tr>
   <tr>
     <td >显示名称：</td>
     <td colspan="2" ><input type="text" size="10" name="showName" /></td>
    </tr>
   <tr>
     <td >字段值：</td>
     <td colspan="2" ><textarea name="keyValue" id="my1" cols="80" rows="12">
  ...
  <tr>
    <td colspan="4" align="center"><input type="submit" value="添加商品自定义字段" /></td>
   </tr>
</table>
</form>
