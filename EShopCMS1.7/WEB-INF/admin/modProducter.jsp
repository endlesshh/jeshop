...
<body>
  ...
  <s:form action="/admin/updateProducter.jspx" method="post">
  <s:hidden name="channelId" value="0"></s:hidden>
  <s:hidden name="producter.channelId" value="0"></s:hidden>
  <s:hidden name="producter.producerId" value="%{producter.getProducerId()}"></s:hidden>
         ...
         <s:textfield 
            ...
            required="true"
            size="40"
            value="%{producter.getProducerName()}"/>
            <s:textfield 
