...
<table  border="00" cellspacing="1" cellpadding="0" id="table" class="sortable">
  ...
  <tr>
    ...
    <input id="strReceiveId"  readonly type="text" onFocus="var rval=window.showModalDialog('ListAllUserSelect.jspx',window,'status:no;scroll:no;dialogWidth:600px;dialogHeight:450px');if(rval!=null){
   ...
   }"     name="strReceiveId" <s:if test="getSpUserId()!=null">value="<s:property value="getSpUserId()"/>"</s:if> /><input title="选择关联用户" onClick="var rval=window.showModalDialog('ListAllUserSelect.jspx',window,'status:no;scroll:no;dialogWidth:600px;dialogHeight:450px');if(rval!=null){
    if(document.getElementById('mitSele').checked==true)
    {
