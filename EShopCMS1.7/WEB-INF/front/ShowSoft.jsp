...
<td colspan="2" style="padding:3px; font-size:12px; ">
  ...
  <tr>
    <td colspan="2" align="center" valign="top"><div class="index_midle_table_bg"><s:property value="soft.getSoftName()"/></div></td>
    </tr>
  <tr>
    <td width="33%" align="center" valign="middle"><img src="../upfile/<s:property value="soft.getSoftPicUrl()"/>" width="150" height="150" /></td>
  ...
  <tr>
    <td colspan="2">
    <br>
    <s:property value="soft.getSoftIntro()"/></td>
    </tr>
    <s:set name="softId" value="soft.getSoftId()"/>
    <s:iterator value="getExtendSoft(#softId)">
   <tr>
    <td colspan="2"><div class="index_midle_table_bg"><s:property   value="showName"/>
    </div>
    </td>
  </tr>
   ...
   <tr>
    <td colspan="2">
    <br>
    <s:property escape="false"  value="conBuffer"/></td>
  </tr>
  </s:iterator>
