...
var ElementCheckInterval = setInterval("updatelist()", 500);
var ElementCheckIntervalduibi = setInterval("updataduibi()",500); 
	...
	for(var i = 0 ;i<elements.length;i++)
	{
		...
		if(tempro.length==0)
		{
			...
			}else
			{
				...
				str =  str + "<tr><td   width=80><b>"+tempro[0]+"</b></td><td width='80'><img style='padding:2px;' title='header=["+tempro[1]+"] body=[<img src=../upfile/"+tempro[4]+" width=130 >]' width=80 height=80 src='../upfile/"+tempro[4]+"'></td><td>"+tempro[1]+"</td><td><b><font color=#ff0000>"+tempro[2]+"</font></b>&nbsp;元</td><td width=150><span style='cursor:hand' onclick='subProNum("+tempro[0]+")'>  减 </span>&nbsp;&nbsp;&nbsp;&nbsp;<b>"+tempro[5]+"</b>("+tempro[7]+")&nbsp;&nbsp;&nbsp;&nbsp;<span  style='cursor:hand' onclick='addProNum("+tempro[0]+")'>  加 </span>&nbsp;&nbsp;&nbsp;<input onblur='addnewProNum("+tempro[0]+",this.value)' name='pro"+tempro[0]+"'  type=text  style='width:20px;' size=4></td><td><b><font color=#ff0000>"+tempro[6]+"</font><b>&nbsp;元</td><td><span style='cursor:hand' onClick='delePro("+tempro[0]+")'>移出购物车</span></td></tr>";
