...
<thread><tr>
  ...
  <s:set name="pagebean" value="pageComMsg()"/>
<s:iterator value="pageComMsg().getList()">
<tr>
  <td>
...
<td title="header=[<s:property value="getsDate()"/>] body=[<s:property value="getMsg()"/>]">消息内容</td><td><s:property value="getsDate()"/></td>
<td>
<a href="delSubMsg.jspx?id=<s:property value="getId()"/>&linkUrl=listcomMsg.jsp">
<img border="0" src="images/userop_03.jpg">
</a>
<a onClick="return confirm('是否确定删除！删除后不可恢复')" href="delOverMsg.jspx?id=<s:property value="getId()"/>&linkUrl=listcomMsg.jsp">
...
<div align="center">
   ...
   <s:url id="ListNews" value="/admin/listConMsg.jspx">
  <s:param name="page"><s:property value="%{#pagebean.currentPage+1}"/></s:param>
        ...
        <s:if test="%{#pagebean.currentPage==1}">
            第一页 上一页        </s:if>
        <s:else>
            <s:url id="firstNews" value="/admin/listConMsg.jspx">
           <s:param name="page">1</s:param>
           </s:url>
            <s:a href="%{firstNews}">第一页</s:a>
              <s:url id="preNews" value="/admin/listConMsg.jspx">
           <s:param name="page"><s:property value="%{#pagebean.currentPage-1}"/></s:param>
           </s:url>
            <s:a href="%{preNews}">上一页</s:a>
        </s:else>
        <s:if test="%{#pagebean.currentPage!=#pagebean.totalPage}">
          <s:url id="nextNews" value="/admin/listConMsg.jspx">
           <s:param name="page"><s:property value="%{#pagebean.currentPage+1}"/></s:param>
          </s:url>
