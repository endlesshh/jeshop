...
<body>
 ...
 function chechSub()
 {
   ...
   if(document.getElementById("wide").value==null||document.getElementById("wide").value.length<=1)
   {
      alert('填写广告的宽度');
   ...
   if(document.getElementById("high").value==null||document.getElementById("high").value.length<=1)
   {
      alert('请输入和填写广告的高度');
	  document.getElementById("high").focus();
	  return false;
   }
    if(document.getElementById("linkUrl").value==null||document.getElementById("linkUrl").value.length<=1)
   {
      alert('请填写广告的链接路径');
  ...
  <s:form action="/admin/addAd.jspx" method="post" onsubmit="return chechSub()">
...
/>
   ...
   id="filename"
           ...
           />
 			<tr><td align="right"></td><td height=20><iframe align=left width="400" height="60" src="upfilesingle.jspx" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes"
