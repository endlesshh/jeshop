  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td background="userLogin/images/class_top_2_11.gif"><img src="userLogin/images/NewsShopShow_21.gif" width="86" height="23" /></td>
            <td width="19" height="33">&nbsp;</td>
        </tr>
          <tr>
            <td background="userLogin/images/class_center_1_11.gif">&nbsp;</td>
            <td align="center">
            
                         <!--自定义商品列表-->
              
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <s:set name="pagebean" value="ShowHotProductPageBean(1,8)"/>
