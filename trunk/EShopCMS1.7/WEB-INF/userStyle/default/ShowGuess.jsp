...
<table width="754" border="0" align="center" cellpadding="0" cellspacing="10">
  ...
  <tr>
    ...
    <input type="text" id="orderNum" value="<s:property value="getOrderCode()"/>"  name="orderNum" style="border:0px #006600 outset; color:#00CC00; font-size:14px; font-weight:bold;"/></td>
  </tr>
  <tr>
    <td>收件人姓名：</td>
  ...
  <tr>
    <td>其他备注信息：</td>
    <td rowspan="2" align="left" valign="top"><textarea id="beizhu" name="beizhu" cols="60" rows="10"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    </tr>
