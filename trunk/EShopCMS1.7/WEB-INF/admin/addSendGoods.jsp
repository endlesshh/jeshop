...
<form action="SendGoodsType.jspx" method="post">
  <tbody>
  <tr>
    <td width="22%">送货方式名称：</td>
    <td width="78%"><input type="text" name="typeName" /></td>
    </tr>
  <tr>
    <td>送货方式说明：</td>
    <td><textarea name="intro" cols="30" rows="8"></textarea></td>
  </tr>
  <tr>
    <td>运费类型：</td>
  ...
  <tr>
    <td>最小运费</td>
    <td><input name="chargeMin" type="text" size="4" /></td>
  </tr>
  <tr>
    <td>最大运费</td>
    <td><input name="chargeMax" type="text" size="4" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
