...
<body>
<form action="updateStyleName.jspx" method="post" >
<s:set name="sid" value="getStyleId()"/>
<s:set name="style" value="find(#sid)"/>
<table width="100%" border="0" cellspacing="4" cellpadding="0">
  ...
  <input type="hidden" name="styleId" value="<s:property value="#style.getStyleId()"/>"/>
  <tr>
    <td width="218">模板名称</td>
    <td width="1097"><input type="text" name="styleName" id="styleName"  value="<s:property value="#style.getStyleName()"/>"/></td>
    <td width="63">&nbsp;</td>
  </tr>
  <tr>
    <td>模板显示名称</td>
    <td><input type="text" name="styleShowName" id="styleShowName" value="<s:property value="#style.getStyleShowName()"/>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>模板路径</td>
    <td><input type="text" name="stylePath" id="stylePath" value="<s:property value="#style.getStylePath()"/>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>模板级别</td>
  ...
  <tr>
    <td>收费价格:(免费则0.00元)</td>
    <td><input type="text"  name="stylePrice" id="stylePrice" size="6" value="<s:property value="#style.getStylePrice()"/>" />元</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>模板缩略图片</td>
    <td><input type="text" name="filename" id="filename" size="40"  value="<s:property value="#style.getStylePic()"/>"/></td>
    <td>&nbsp;</td>
  </tr>
