...
<body>
  ...
  <s:form action="/admin/updateChannel.jspx" method="post">
 ...
 <tr><td colspan="2" align="center"><font color=#ff0000>频道的名称是您在导航栏目中显示您的频道的名称</font></td></tr>           
           ...
           <s:select
            ...
            name="moduleType"
            emptyOption="false"
            value="%{jechan.getModuleType()}" onchange="showOption(this.value)"/>
            ...
            tooltip="填写频道的名称" 
            value="%{jechan.getChannelShortName()}"/>
            
            <s:textfield 
            label="填写频道的英文名称(标记频道)" 
            name="channelDir"
            tooltip="填写频道的名称" 
            value="%{jechan.getChannelDir()}"/>
              <tr><td colspan="2" align="center"><font color=#ff0000>频道的英文名称</font></td></tr>
         
             <s:textfield  id="lurl"
            label="填写频道的路径(表示频道要跳转到什么地址！)" 
            name="LinkUrl"
            tooltip="填写频道的路径，频道要跳转到的地址" size="40"
            value="%{jechan.getLinkUrl()}"
            />
             
      
             <tr><td align="right">选择模板</td><td  align="left"> 
             <s:if test="jechan.moduleType==2">
             <select onChange="document.getElementById('lurl').value=this.value" id="sfile" >
             <option >请下拉选择模板</option>
             <s:iterator value="ml_ShopchannelTemp">
            ...
            tooltip="填写频道的名称" 
            value="%{jechan.getChannelItemUnit()}"/>
          <tr><td colspan="2" align="center"><font color=#ff0000>该处是频道的记录单位，例如您的商品有15件！“件” 就是该处填写的单位</font></td></tr>       
            ...
            rows="5"
            id="mede"
            value="%{jechan.getMetaDescription()}"
            />
