...
<table width="95%"  border="00" cellpadding="0" cellspacing="1" class="sortable" id="table">
    ...
    <td width="40%">值：<a href="ShowDetailSoft.jspx?channelId=<s:property value="getChannelId()"/>&softId=<s:property value="getSoftId()"/>&varname=<s:property value="toString()"/>">    修改字段值</a></td>
    <td width="41%"><a href="deleSoftExtend.jspx?channelId=<s:property value="getChannelId()"/>&varname=<s:property value="toString()"/>&softId=<s:property value="getSoftId()"/>">删除字段</a></td>
  </tr>
      </s:iterator>
  </table>

<form action="addExtendSoft.jspx" method="post">
