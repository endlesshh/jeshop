...
<input type="button" value="添加新的幻灯" onClick="window.location.href='addSildpic.jspx'"><input type="button" value="管理首页幻灯图片" onClick="window.location.href='listSlid.jspx'">
    ...
    return false;
     ...
     <s:form action="addSlid.jspx" method="post" onsubmit="return checksub()">
    <s:label  value="添加首页幻灯图片"></s:label>
    <s:textfield tooltip="幻灯名称" id="user" label="显示幻灯的名称" name="name"></s:textfield>
    <s:textfield tooltip="幻灯显示文本文字" id="pass" label="幻灯显示文本文字" name="text"></s:textfield>
    <s:textfield tooltip="幻灯链接地址" id="link" label="幻灯显示图片链接地址" name="linkUrl"></s:textfield>
    <s:token></s:token>
    <s:textfield 
   id="filename"
   			label="请上传幻灯显示的图片"
