...
<table  border="00" cellspacing="1" cellpadding="0" id="table" class="sortable">
 <thead> 
      ...
      <tr>
        <th colspan="2" class="nosort" >自定义页面分类管理</th>
      </tr>
  </thead><form action="modUserDefindClass.jspx" method="post">
     <tbody>
      <tr>
        <td class="nosort" >自定义页面分类名称</td>
        <td >
        <input type="hidden" name="id" value="<s:property value="jedefine.getId()"/>"/>
        <input type="text" name="Name" value="<s:property value="jedefine.getName()"/>"/>        </td>
      </tr>
      <tr>
