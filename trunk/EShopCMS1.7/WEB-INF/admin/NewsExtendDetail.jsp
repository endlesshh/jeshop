...
<input type="button" value="返回上层" onClick="window.location.href='extendNews.jspx?artId=<s:property value="getArtId()"/>&channelID=<s:property value="getChannelID()"/>'" />
<form action="SaveDetailNewsEx.jspx" method="post">
...
<input type="hidden" name="artId" value="<s:property value="getArtId()"/>" />
 <table width="95%"  border="00" cellpadding="0" cellspacing="1" class="sortable" id="table">
   ...
   <tr>
     <td >显示名称：</td>
     <td colspan="2" ><input type="text" size="40"  readonly name="fileSBuffer" value="<s:property value="getFileSBuffer()"/>" />  </td>
    </tr>
   <tr>
     <td >字段值</td>
