...
<input type="button" value="返回上层" onClick="window.location.href='extendProduct.jspx?productId=<s:property value="getProductId()"/>&channelId=<s:property value="getChannelId()"/>'" />
<form action="SaveDetailEx.jspx" method="post">
...
<input type="hidden" name="productId" value="<s:property value="getProductId()"/>" />
 <table width="95%"  border="00" cellpadding="0" cellspacing="1" class="sortable" id="table">
  ...
  <tr>
    <td colspan="4" align="center"><input type="submit" value="保存商品自定义字段" /></td>
   </tr>
</table>
</form>
