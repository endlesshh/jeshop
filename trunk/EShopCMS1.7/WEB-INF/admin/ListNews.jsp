      ...
      <s:iterator value="pagebean.list" status="listjeannounce">
       ...
       <s:a href="%{ContactUrl}"> <img border="0" src="imgs/openpro_07.jpg"></s:a>
        ...
        <s:url id="seturl" value="/admin/findNews.jspx">
          ...
          <td class="channel_title"><s:a href="%{deleurl}" onclick="return confirm('确定要删除吗?')"><img border="0" src="imgs/openpro_10.jpg"></s:a></td>
          <td class="channel_title"><s:a href="%{seturl}"><img  border="0" src="imgs/openpro_09.jpg"></s:a></td>
        </tr>
        </tbody>
      </s:iterator>
</table>
