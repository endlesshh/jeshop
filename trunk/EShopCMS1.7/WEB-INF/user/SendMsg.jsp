...
<form action="UpdateMsg.jspx" method="post">
<table  border="00" cellspacing="1" cellpadding="0" >
  ...
  <tr>
    ...
    <input id="strReceiveId"  readonly type="text" onFocus="var rval=window.showModalDialog('ListSelectAdmin.jspx',window,'status:no;scroll:no;dialogWidth:600px;dialogHeight:450px');if(rval!=null){
   ...
   }"     name="strReceiveId" <s:if test="getSpUserId()!=null">value="<s:property value="getSpUserId()"/>"</s:if> />
   
   <input title="选择关联用户" onClick="var rval=window.showModalDialog('ListSelectAdmin.jspx',window,'status:no;scroll:no;dialogWidth:600px;dialogHeight:450px');if(rval!=null){
    if(document.getElementById('mitSele').checked==true)
    {
   ...
   document.getElementById('strReceiveId').value=rval
    ...
    }" type="button" value="选择管理员..." /> 
   
   <input title="选择关联用户" onClick="var rval=window.showModalDialog('ListAllUserSelect.jspx',window,'status:no;scroll:no;dialogWidth:600px;dialogHeight:450px');if(rval!=null){
    if(document.getElementById('mitSele').checked==true)
    {
    var str = document.getElementById('strReceiveId').value;
    if(str.length<=0)
