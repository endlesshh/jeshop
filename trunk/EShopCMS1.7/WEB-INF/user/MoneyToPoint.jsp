...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td align="left" valign="top" background="images/images/userCenterMainBg_03.gif" style="background-repeat:repeat-x;">积分转化成钱
          <table width="450" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><input type="button" value="账户余额转换成点数" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><input type="button" value="账户余额转换成点数" /></td>
